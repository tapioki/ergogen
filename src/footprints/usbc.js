module.exports = {
    ...
    body: p => {
        const standard = `
          ...
          (fp_line (start ${p.xy(7, 0)}) (end ${p.xy(4.64, 0)}) (layer Edge.Cuts) (width 0.2))
          (fp_line (start ${p.xy(-7, 0)}) (end ${p.xy(-4.64, 0)}) (layer Edge.Cuts) (width 0.2))
          (fp_line (start ${p.xy(-4.64, 6.66)}) (end ${p.xy(4.64, 6.66)}) (layer Edge.Cuts) (width 0.2))
          (fp_line (start ${p.xy(-4.64, 6.66)}) (end ${p.xy(-4.64, 0)}) (layer Edge.Cuts) (width 0.2))
          (fp_line (start ${p.xy(4.64, 6.66)}) (end ${p.xy(4.64, 0)}) (layer Edge.Cuts) (width 0.2))
          (pad "1" smd rect (at 3.225 7.235) (size 0.6 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.GND.str})
          (pad "2" smd rect (at 2.45 7.235) (size 0.6 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.VBUS.str})
          (pad "3" smd rect (at 1.75 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask))
          (pad "4" smd rect (at 1.25 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.CC1.str})
          (pad "5" smd rect (at 0.75 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.DP.str})
          (pad "6" smd rect (at 0.25 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.DN.str})
          (pad "7" smd rect (at -0.25 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.DP.str})
          (pad "8" smd rect (at -0.75 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.DN.str})
          (pad "9" smd rect (at -1.25 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.CC2.str})
          (pad "10" smd rect (at -1.75 7.235) (size 0.3 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask))
          (pad "11" smd rect (at -2.45 7.235) (size 0.6 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.VBUS.str})
          (pad "12" smd rect (at -3.225 7.235) (size 0.6 1.15) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.GND.str})
          (pad "13" thru_hole oval (at 5.62 6.1) (size 1 1.8) (drill oval 0.6 1.4) (layers *.Cu *.Mask) ${p.net.GND.str})
          (pad "13" thru_hole oval (at -5.62 6.1) (size 1 1.8) (drill oval 0.6 1.4) (layers *.Cu *.Mask) ${p.net.GND.str})
          (pad "13" thru_hole oval (at -5.62 2.1) (size 1 2.2) (drill oval 0.6 1.8) (layers *.Cu *.Mask) ${p.net.GND.str})
          (pad "13" thru_hole oval (at 5.62 2.1) (size 1 2.2) (drill oval 0.6 1.8) (layers *.Cu *.Mask) ${p.net.GND.str})
          )
          `
          function components(label, x, y, rot, to, from) {
            return `
              ...
              ${'' /* footprint reference */}
              (at ${p.xy(x, y)} ${rot})
              (fp_text reference "${label}" (at ${Math.abs(rot) == 90 ? '-2 0' : '0 -1'}) (layer F.SilkS) (effects (font (size 0.3 0.3) (thickness 0.05))))
              (fp_line (start ${p.xy(-1.35, 0.55)}) (end ${p.xy(-1.35, -0.55)}) (layer F.SilkS) (width 0.2))
              (fp_line (start ${p.xy(1.35, 0.55)}) (end ${p.xy(-1.35, 0.55)}) (layer F.SilkS) (width 0.2))
              (fp_line (start ${p.xy(1.35, -0.55)}) (end ${p.xy(1.35, 0.55)}) (layer F.SilkS) (width 0.2))
              (fp_line (start ${p.xy(-1.35, -0.55)}) (end ${p.xy(1.35, -0.55)}) (layer F.SilkS) (width 0.2))
          ...
          ${'' /* footprint reference */}
          (at ${p.xy(5.725, 11.5)} -90)
          (fp_text reference "SRO5" (at 0 0) (layer F.SilkS) (effects (font (size 0.3 0.3) (thickness 0.05))))
          (pad 3 smd rect (at 0.96 1.1 90) (size 1 1.4) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask)
            ${p.net.DP.str} (clearance 0.1))
          (pad 4 smd rect (at 0.96 -1.1 90) (size 1 1.4) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask)
            ${p.net.VCC.str} (clearance 0.1))
          (pad 2 smd rect (at -0.96 1.1 90) (size 1 1.4) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask)
            ${p.net.DN.str} (clearance 0.1))
          (pad 1 smd rect (at -0.76 -1.1 90) (size 1.2 1.4) (layers ${p.param.side}.Cu ${p.param.side}.Paste ${p.param.side}.Mask)
